...
if __name__ == '__main__':
    ...
    parser.add_argument("-looper_identifier", type=str, required=True, help='Looper identifier')
    ...
    with tf.Session(config=cfg) as sess:
        ...
        qgen_saver.restore(sess,os.path.join(args.networks_dir,'loop',args.looper_identifier,'params.ckpt'))
        ...
        loop_saver.restore(sess, os.path.join(args.networks_dir,'loop',args.looper_identifier,'params.ckpt'))
